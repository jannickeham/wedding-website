...
const infoBotne =
  "Vielsen vil finne sted i Botne Kirke kl. 13:00, i Holmestrand kommune. Her er Ben både døpt og konfirmert, vakre uteområder, og gode parkeringsmuligheter.";
  ...
  return (
    <>
      <div className="info-div">
        ...
        <p className="info-adress">{adress}</p>
